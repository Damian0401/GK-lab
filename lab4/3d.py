...
def fix_center():
    center[0] = math.cos(-theta * math.pi / 180) * math.cos(phi * math.pi / 180) * R
    center[1] = math.sin(phi * math.pi / 180) * R
    center[2] = math.sin(-theta * math.pi / 180) * math.cos(phi * math.pi / 180) * R
